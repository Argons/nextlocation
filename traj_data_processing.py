...
def clean_traj_data(data_file_name, options):
    """
    Clean raw user trajectory data, and convert it into a dictionary of
...
def plot_traj_on_baidu(data_file_name, options, dev_ak='ZsqMjA0ruVar6oDqPnOSLpRH'):
    """
    ...
    if options['polyline'] == True: # plot polylines on Baidu map
        polyline = """
            var polyline = new BMap.Polyline(points,{strokeColor:point_color, strokeWeight:2, strokeOpacity:0.8});  //创建折线覆盖物  
